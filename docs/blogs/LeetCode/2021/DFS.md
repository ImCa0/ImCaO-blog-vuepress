...
![islands](./DFS.assets/islands.jpg)
...
![neighbor](./DFS.assets/neighbor.jpg)

其次，网格 DFS 中的 base case 是什么？从二叉树的 base case 对应过来，应该是网格中不需要继续遍历、`grid[r][c]` 会出现数组下标越界异常的格子，也就是那些超出网格范围的格子。

![OutOfBounds](./DFS.assets/OutOfBounds.jpg)
...
![InfiniteLoop](./DFS.assets/InfiniteLoop.gif)
...
![MakingALargeIsland3](./DFS.assets/MakingALargeIsland3.jpg)
...
![IslandPerimeter1](./DFS.assets/IslandPerimeter1.jpg)
:::
...
![IslandPerimeter2](./DFS.assets/IslandPerimeter2.jpg)
